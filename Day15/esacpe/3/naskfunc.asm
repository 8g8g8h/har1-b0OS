...
taskswitch3     ;void taskswitch(void);
        JMP     3*8:0
        RET

taskswitch4     ;void taskswitch(void);
        JMP     4*8:0
        RET

farjmp          ;void farjmp(int eip,int cs);ここでfarjmpの「JMP　FAR」という命令は最初にEIPに４バイトを格納、その後CSに隣の2バイトを入れる
        JMP     FAR [ESP+4]
        RET
