...
make_textbook8(sht_win, 8, 28, 144, 16, COL8_FFFFFF);
    ...
    task_a_esp=memman_alloc_4k(memman,64*1024)+64*1024+64*1024;
    tss_a.eip=(int) &task_a_main;
    tss_a.eflags=0x00000202;/*IF = 1;*/
    tss_a.eax=0;
    tss_a.ecx=0;
    tss_a.edx=0;
    tss_a.ebx=0;
    ...
    tss_a.fs=1*8;
    tss_a.gs=1*8;
    load_tr(3*8);//今動いているタスクがどこにあるのかを示している(この場合はGDTの3番目)
