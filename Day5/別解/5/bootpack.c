...
void HariMain(void){
    ...
    putfont8(vram,xsize,16,8,COL8_FFFFFF,hankaku+'B'*16);
    putfont8(vram,xsize,24,8,COL8_FFFFFF,hankaku+'C'*16);
    putfont8(vram,xsize,40,8,COL8_FFFFFF,hankaku+'1'*16);
    putfont8(vram,xsize,48,8,COL8_FFFFFF,hankaku+'2'*16);
    putfont8(vram,xsize,56,8,COL8_FFFFFF,hankaku+'3'*16);
