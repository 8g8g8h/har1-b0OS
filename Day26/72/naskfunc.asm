...
; このプログラムに含まれる関数名
	...
	GLOBAL	asm_inthandler20,asm_inthandler21, asm_inthandler2c,asm_inthandler0c,asm_inthandler0d
	...
	GLOBAL	start_app,asm_end_app
  	GLOBAL  farcall 
  	EXTERN  inthandler20, inthandler21, inthandler2c,inthandler0d,inthandler0c
  	EXTERN  hrb_api
